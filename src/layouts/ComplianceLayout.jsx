...
const ComplianceLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/compliance/reports', icon: MdCheckCircle, label: 'Reports' },
  ];
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <h1 className="text-xl font-bold text-green-600">HealthGov</h1>
          <button
            onClick={() => setSidebarOpen(false)}
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 lg:hidden">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <h1 className="text-lg font-semibold text-gray-900">HealthGov Compliance Portal</h1>
